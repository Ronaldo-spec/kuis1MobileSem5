...
import org.aplas.kuis.QuizContract.*;
...
public class QuizDbHelper extends SQLiteOpenHelper {
    ...
    private void fillCategoriesTable() {
        org.aplas.kuis.Category c1 = new org.aplas.kuis.Category("HTML");
        insertCategory(c1);

        org.aplas.kuis.Category c2 = new org.aplas.kuis.Category("Java");
        insertCategory(c2);

    }

    private void insertCategory(org.aplas.kuis.Category category) {
    ...
    public List<org.aplas.kuis.Category> getAllCategories() {
        List<org.aplas.kuis.Category> categoryList = new ArrayList<>();
        db = getReadableDatabase();
        Cursor cursor = db.rawQuery("SELECT * FROM " + CategoriesTable.TABLE_NAME, null);
        if (cursor.moveToFirst()) {
            do {
                org.aplas.kuis.Category category = new org.aplas.kuis.Category();
