...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int categoryID = intent.getIntExtra(halamanquiz.EXTRA_CATEGORY_ID, 0);
        String categoryName = intent.getStringExtra(halamanquiz.EXTRA_CATEGORY_NAME);
        String difficulty = intent.getStringExtra(halamanquiz.EXTRA_DIFFICULTY);
